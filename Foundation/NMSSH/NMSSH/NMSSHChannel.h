...
/**
 Execute a shell command on the server with live output.
 ...
 @param error Error handler
 @param timeout The time to wait (in seconds) before giving up on the request 
 @param output block get called when data read
 @param terminator checked each time reading data from ssh channel
 @param exitCode returns exit code
 @returns Shell command response
 */
